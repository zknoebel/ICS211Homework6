...
public class FoodlandTest {
	 ...
	 *
	 * This test won't check that the simulation ran correctly; it just tests
	 * that it terminates. The timeout in the @Test annotation has a timeout of
	 * 1s.
	 */
	@Test(timeout = 1000)
	...
	public void testMovedExpressLaneShopper() {
		...
		/*
		 * Get output of test as a string and then check for the string "moved".
		 * The program (as shown by the example in the assignment) should have
		 * printed a message stating that a shopper was "moved" from an express
		 * lane because they had more than 10 items.
		 */
